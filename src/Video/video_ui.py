...
def initui(self):
    ...
    self.logo = QLabel()
    pixmap = QPixmap(os.path.join(pathlib.Path(__file__).parent.resolve(), r"../../Logo/logo_ids.jpg"))
    ...
    self.counter_fps_label = QLabel("FPS : ")
    self.counter_fps_label.setVisible(False)
